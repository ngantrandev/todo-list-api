...
--
-- Host: mysqldbhost
-- Generation Time: Mar 21, 2025 at 03:17 AM
...
(9, 'Đọc sách về AI', 'Tìm hiểu về machine learning', '2025-03-13 15:00:00', 2, 0, 1),
(10, 'Tập gym', 'Rèn luyện thể lực', '2025-03-13 06:30:00', 1, 0, 1),
(11, 'Dọn dẹp phòng', 'Sắp xếp lại sách vở', '2025-03-14 09:00:00', 0, 0, 1),
(12, 'Lập kế hoạch tuần mới', 'Ghi lại các công việc quan trọng', '2025-03-14 20:00:00', 2, 0, 1),
(13, 'Xem phim', 'Thư giãn cuối tuần', '2025-03-15 21:00:00', 0, 0, 1),
(14, 'Chạy bộ công viên', 'Tập thể dục sáng', '2025-03-15 07:00:00', 1, 0, 1),
(15, 'Học lập trình Golang', 'Xây dựng API với Golang', '2025-03-16 19:00:00', 2, 0, 1),
(16, 'Viết blog cá nhân', 'Chia sẻ về công nghệ', '2025-03-16 22:00:00', 2, 0, 1),
(17, 'Mua sắm', 'Mua đồ dùng cần thiết', '2025-03-17 17:30:00', 1, 0, 1),
(18, 'Luyện nói tiếng Anh', 'Thực hành giao tiếp với bạn bè', '2025-03-17 14:00:00', 2, 0, 1),
(19, 'Tham gia hội thảo công nghệ', 'Tìm hiểu về AI mới', '2025-03-18 18:00:00', 3, 0, 1),
(20, 'Viết báo cáo công việc', 'Tổng kết tiến độ dự án', '2025-03-18 10:00:00', 2, 0, 1),
(21, 'Học React Native', 'Xây dựng ứng dụng mobile', '2025-03-19 20:30:00', 2, 0, 1),
...
(25, 'Học cách sử dụng Docker', 'Triển khai ứng dụng với Docker', '2025-03-21 19:00:00', 2, 0, 1),
...
(29, 'Làm bài tập Python', 'Bài tập về thuật toán', '2025-03-23 11:00:00', 2, 0, 1),
(30, 'Tập yoga', 'Giãn cơ buổi sáng', '2025-03-23 06:30:00', 1, 0, 1),
(31, 'Nấu ăn', 'Chuẩn bị bữa tối cho gia đình', '2025-03-24 18:00:00', 1, 0, 1),
(32, 'Học SQL nâng cao', 'Truy vấn dữ liệu phức tạp', '2025-03-24 20:00:00', 2, 0, 1),
(33, 'Chơi game', 'Thư giãn cuối tuần', '2025-03-25 22:00:00', 0, 0, 1),
(34, 'Học cách dùng Redis', 'Lưu trữ dữ liệu hiệu suất cao', '2025-03-25 19:00:00', 2, 0, 1),
(35, 'Học vẽ', 'Thử vẽ chân dung', '2025-03-26 16:00:00', 1, 0, 1),
(36, 'Đi siêu thị', 'Mua sắm đồ dùng cá nhân', '2025-03-26 18:30:00', 1, 0, 1),
(37, 'Xem video học React', 'Hiểu cách xây dựng UI', '2025-03-27 20:30:00', 2, 0, 1),
(38, 'Làm bài kiểm tra Java', 'Thực hành lập trình', '2025-03-27 09:00:00', 2, 0, 1),
(39, 'Tham gia lớp học online', 'Khóa học lập trình miễn phí', '2025-03-28 19:30:00', 2, 0, 1),
...
(42, 'Học Node.js', 'Viết API với Express', '2025-03-29 21:00:00', 2, 0, 1),
(43, 'Đi phượt cuối tuần', 'Khám phá địa điểm mới', '2025-03-30 08:00:00', 3, 0, 1),
(44, 'Học cách đầu tư tài chính', 'Quản lý tài chính cá nhân', '2025-03-30 18:00:00', 2, 0, 1),
...
(48, 'Viết bài trên Medium', 'Chia sẻ kinh nghiệm lập trình', '2025-04-01 22:00:00', 2, 0, 1),
(49, 'Tìm hiểu Kubernetes', 'Quản lý container ở quy mô lớn', '2025-04-02 19:30:00', 2, 0, 1),
